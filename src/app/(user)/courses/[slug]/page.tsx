...
async function CoursePage({ params }: { params: Params }) {
  const { slug } = await params;
  const data = await getCourse(slug);

  return (
    <div className="grid grid-cols-1 gap-10 lg:grid-cols-3 mt-5 ">
      <div className="order-1 lg:col-span-2">
        <div className="relative aspect-video w-full overflow-hidden rounded-xl shadow-lg">
          <Image
            src={`https://academy.fly.storage.tigris.dev/${data.fileKey}`}
        ...
        <div className="space-y-4">
          {data.chapter.map((chapter, index) => (
        ...
        <div className="sticky top-20">
          <Card className=" py-8">
            <CardContent className="p-6">
              ...
              <div className="mb-6 space-y-3 roumd">
              ...
              <div className="mb-6 space-y-3">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Access to mobile and desktop</span>
                  </li>
                  <li className="flex items-center gap-2 text-sm">
                    <div className="rounded-full bg-green-500/10 text-green-500">
                      <CheckIcon className="size-3" />
